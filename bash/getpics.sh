...
#     then delete the local copy of the tarfile if the extraction was successful
wget -q -O ~/public_html/pics/pics.tgz http://zonzorp.net/pics.tgz && tar -xzf ~/public_html/pics/pics.tgz -C ~/public_html/pics || (echo "Failed to download and execute the file" && exit 1) && rm ~/public_html/pics/pics.tgz
